...
1. Recover the training config + val curve for the best LFM run (r32 encoder LoRA + FLEURS mix)
   ...
   documented recipe.
2. Run FT-Whisper over `fleurs_ja_jp_test200` / `fleurs_en_us_test200` to complete Table 3.
3. Bootstrap CIs over the 196 CS utterances for every row of Table 3.
